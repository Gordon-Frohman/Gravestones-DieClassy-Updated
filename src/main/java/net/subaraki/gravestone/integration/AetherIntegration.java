...
public class AetherIntegration {
    ...
    public static ItemStack removeStackFromSlot(EntityPlayer player, int slotID) {
        AccessoryType[] slotTypes = new AccessoryType[] { AccessoryType.PENDANT, AccessoryType.CAPE,
            AccessoryType.SHIELD, AccessoryType.MISC, AccessoryType.RING, AccessoryType.EXTRA_RING,
            AccessoryType.GLOVES, AccessoryType.EXTRA_MISC };
